...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        datePicker = [[UIDatePicker alloc]initWithFrame:CGRectMake(0, 25,viewFrames.size.width, 216)];
...
-(void) popDatePickerView
{
    [UIView animateWithDuration:0.2 animations:^{
        ...
        self.frame = CGRectMake(0, viewFrames.size.height - 256, viewFrames.size.width, 256);
...
-(void) hiddenDatePickerView
{
    ...
    [UIView animateWithDuration:0.2 animations:^{
        ...
        self.frame = CGRectMake(0, viewFrames.size.height, viewFrames.size.width, 256);
...
-(void)toolTateBar
{
    ...
    UIView * topView = [[UIView alloc]initWithFrame:CGRectMake(0, 0, viewFrames.size.width, 30)];
    
    UIButton * leftBtn = [[UIButton alloc]initWithFrame:CGRectMake(8, 5, 60, 30)];
    leftBtn.selected = NO;
    [leftBtn setTitle:@"Cancle" forState:UIControlStateNormal];
    ...
    UIButton * rightBtn = [[UIButton alloc]initWithFrame:CGRectMake(viewFrames.size.width - 68, 5, 60, 30)];
    [rightBtn setTitle:@"OK" forState:UIControlStateNormal];
