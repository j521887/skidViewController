...
-(void)topColor
{
    ...
    topColor.backgroundColor  = [UIColor colorWithRed:128/255.0 green:191/255.0 blue:88/255.0 alpha:1];
...
-(void)detailViews
{
    ...
    detailView.layer.borderColor = [[UIColor colorWithRed:128/255.0 green:191/255.0 blue:88/255.0 alpha:1] CGColor];
...
-(void)showdateLabel
{
    ...
    dateLabel.text = [TCDatePickerView getNowDateFormat:@"M.d HH:mm"];
   ...
   // dateLabel.userInteractionEnabled = YES;
    ...
    self.diaryNote.time = [TCDatePickerView getNowDateFormat:@"yyyy.M.d HH:mm"];
...
-(void)showWeather
{
    ...
    weatherField.placeholder = @"Weather";
...
-(void)backBtn
{
    ...
    [backBn setTitle:@"Cancle" forState:UIControlStateNormal];
...
-(void)save:(id)sender
{
    ...
    {
        [MBProgressHUD showError:@"Not Null😱😱"];
...
-(void)didSaveDate
{
    self.dateLabel.text = [self.pickerView getNowDatePicker:@"M.d HH:mm"];
    self.diaryNote.time = [self.pickerView getNowDatePicker:@"yyyy.M.d HH:mm"];
