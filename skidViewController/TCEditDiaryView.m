...
@interface TCEditDiaryView ()<UITextViewDelegate,UIScrollViewDelegate>//TCDatePickerViewDelegate
...
-(void)beginEdit:(id)sender
{
    ...
    //进入编辑模式
    if ([[sender title] isEqualToString:@"Change"])
    {
